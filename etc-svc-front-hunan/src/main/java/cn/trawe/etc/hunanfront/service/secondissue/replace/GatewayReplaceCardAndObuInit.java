...
@Service
@Slf4j
public class GatewayReplaceCardAndObuInit extends BaseService{
	...
	public SecondIssueResp init(SecondIssueReq req, ThirdPartner partner) {
		...
		String accountNo = partner.getAccountNo();
      	...
      	gateWaySumbitReq.setBussType(13);
      	gateWaySumbitReq.setFaceCardNum(req.getOldCardNo().substring(4));
